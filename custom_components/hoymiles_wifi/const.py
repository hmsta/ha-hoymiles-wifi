...
CONF_METER_ENERGY_CONSISTENCY_TOLERANCE = "meter_energy_consistency_tolerance"
...
DEFAULT_METER_ENERGY_CONSISTENCY_TOLERANCE = 1000
MIN_METER_ENERGY_CONSISTENCY_TOLERANCE = 0
